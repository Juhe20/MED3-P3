...
def DetectAndCountCircles(path):
    ...
    if detected_circles is not None:
        ...
        for pt in detected_circles[0,:]:
            ...
            #if both thresholds have been set it will check the intensity and add geese/foxes accordingly
            ...
            if threshold1 == -1:
                ...
                geese += 1
            #then on the next iteration we first check if the mean_intensity + our tolerance is smaller than our threshold1
                ...
                #if the first 1 or first two was white, and we then find a black, we can then set the foxes to geese
                #and subtract the foxes-1 from the geese, because the new we found was black so if we just subtracted white we would be 1 black short
                foxes = geese
                geese -= foxes - 1
        ...
        cv2.waitKey(0)
        return total_circles, foxes, geese
    else:
